...
class ToysControllerTest < ActionController::TestCase
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post :create, toy: { description: @toy.description, image_url: @toy.image_url, price: @toy.price, title: @toy.title }
    end
  ...
  test "should update toy" do
    patch :update, id: @toy, toy: { description: @toy.description, image_url: @toy.image_url, price: @toy.price, title: @toy.title }
    assert_redirected_to toy_path(assigns(:toy))
  end
